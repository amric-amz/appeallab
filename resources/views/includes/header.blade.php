				...
				<div class="main-bar clearfix ">
					<div class="container-fluid clearfix">
						...
						<div class="logo-header mostion logo-dark">
							<!-- <a href="{{ route('home') }}"><img src="{{ asset('images/wally_logo.png') }}" alt="" style="height:60px; width: 150px;"></a> -->
							<span style="height: 60px; width: 150px; font-size: 45px; letter-spacing: 0px;">Appeal</span>
						</div>
						<!-- Nav Toggle Button -->
						...
						<div class="header-nav navbar-collapse collapse" id="navbarNavDropdown">
							...
							<!-- <ul class="nav navbar-nav navbar navbar-left">	
								<li class=""><a href="javascrit:void(0)">
