<head>
    ...
    <link href="{{ asset('js/bootstrap-select/dist/css/bootstrap-select.min.css') }}" rel="stylesheet">
    

	<link href="{{ asset('js/datatables/css/jquery.dataTables.min.css') }}" rel="stylesheet">
